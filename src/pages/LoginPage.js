...
function LoginPage() {
    ...
    return(
        <div className="flex flex-col justify-center min-h-screen min-w-screen bg-gradient-to-br from-light-bg to-dark-bg text-white text-center">
            ...
            <form className="flex flex-col items-center gap-4 mt-4" onSubmit={handleSubmit}>
                <input
                    className="w-[70%] max-w-sm py-2 px-6 rounded text-gray-600 focus:outline-none"
                    type="text"
                ...
                <input 
                    ...
                    required
                />
                <p className="text-sm text-gray-400"> Demo Account (User: demo@gmail.com - Password: demo1234)</p>
                <p className="text-sm mb-8">Don't have an account yet? <Link className="font-semibold ml-2" to="/signup">Sign up now.</Link></p>
